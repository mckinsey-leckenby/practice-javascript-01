...
//   console.log(fullAuthorNames)
  ...
  //filter and map create a map of name strings 30 years and older. 

  let thirtyAndOlderNames = users.filter(user => user.age >= 30).map(user => user.name)

  console.log(thirtyAndOlderNames)